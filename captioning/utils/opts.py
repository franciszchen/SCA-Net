...
def parse_opt():
    ...
    # cz add
    parser.add_argument('--loss_text_factor', type=float, default=1.0)
    parser.add_argument('--loss_visual_factor', type=float, default=1.0)
    parser.add_argument('--loss_align_v2t_c_factor', type=float, default=1.0)
    parser.add_argument('--loss_align_t2v_c_factor', type=float, default=1.0)
    
    parser.add_argument('--input_img_dir', type=str, default='',
                    help='path to the directory containing the images')
    parser.add_argument('--sequence_length', type=int, default=5,
                    help='the sequence length of one video clip')

    parser.add_argument('--image_size', type=int, default=224,
                    help='the height and width of one image') 
    ...
    parser.add_argument('--patch_size', type=int, default=8,
                    help='the height and width of one patch')
    parser.add_argument('--in_channels', type=int, default=3,
                    help='RGB channels of one image')
    parser.add_argument('--dim', type=int, default=2048,
                    help='feature size after patch embedding')
    parser.add_argument('--emb_dropout', type=float, default=0.1,
                    help='dropout probability')
    # parser.add_argument('--val_batch_size', type=int, default=15,
    #                 help='feature size after patch embedding')
    parser.add_argument('--max_detections', type=int, default=6,
                    help='first 6 detection features')
    parser.add_argument('--input_yolofeature_dir', type=str, default='',
                    help='path to the yolofeature')

    parser.add_argument('--pool_size', type=int, default=3,
                    help='pool_size')
    parser.add_argument('--window_size', type=int, default=14,
                    help='window_size') # default=14
    # 上述为xu新增                                
    # =============================================================== #
    # 与ruotian luo保持一致
    ...
    parser.add_argument('--learning_rate', type=float, default=4e-4,
                    help='learning rate')
    parser.add_argument('--learning_rate_init', type=float, default=4e-4,
                    help='learning rate')
    parser.add_argument('--learning_rate_warmup_end', type=int, default=-1, 
                    help='at what iteration to end warming-up learning rate? (-1 = dont) (in epoch)')
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./experiment/',
                    help='directory to store checkpointed models') # 保存的路径
